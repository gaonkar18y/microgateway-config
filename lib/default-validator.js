...
module.exports.validate = function validate(configObject) {
  ...
  if (config.edgemicro.hasOwnProperty('noProxyFoundMessage')) {
    assert(typeof config.edgemicro.noProxyFoundMessage === 'string', 'config.edgemicro.noProxyFoundMessage is not an string');
  }
